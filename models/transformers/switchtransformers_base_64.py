# labels: name::switchtransformers_base_64 author::transformers task::Generative_AI license::apache-2.0
...
if pretrained:
    model = SwitchTransformersModel.from_pretrained("google/switch-base-64")
else:
