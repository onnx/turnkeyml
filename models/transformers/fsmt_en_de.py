# labels: name::fsmt_en_de author::transformers task::Generative_AI license::apache-2.0
from turnkeyml.parser import parse
from transformers import FSMTModel, AutoTokenizer
import torch
...
if pretrained:
    ...
    model = FSMTModel.from_pretrained("facebook/wmt19-en-de")
else:
    raise ValueError(
