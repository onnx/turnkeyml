# labels: name::longt5_tglobal_large author::transformers task::Generative_AI license::apache-2.0
...
if pretrained:
    ...
    config = AutoConfig.from_pretrained("google/long-t5-tglobal-large")
